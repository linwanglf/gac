...
QT_MOC_LITERAL(3, 18, 24),
QT_MOC_LITERAL(4, 43, 26)
    },
    "Thread\0Add_State\0\0Timer_OS_Progress_thread\0"
    "Timer_COM2_Progress_thread\0"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->Add_State((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->Timer_OS_Progress_thread(); break;
        case 2: _t->Timer_COM2_Progress_thread(); break;
        default: ;
        }
        ...
        {
            typedef void (Thread::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thread::Add_State)) {
                *result = 0;
            }
        }
        {
            typedef void (Thread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thread::Timer_OS_Progress_thread)) {
                *result = 1;
            }
        }
        {
            typedef void (Thread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thread::Timer_COM2_Progress_thread)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 0
void Thread::Add_State(const QString & _t1)
{
...
// SIGNAL 1
void Thread::Timer_OS_Progress_thread()
{
    QMetaObject::activate(this, &staticMetaObject, 1, 0);
}

// SIGNAL 2
void Thread::Timer_COM2_Progress_thread()
{
